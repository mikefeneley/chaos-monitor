...
class TestDBConnector(unittest.TestCase):
    ...
    def delete_test_db(self):
        try:
            self.test_cursor.execute("DROP DATABASE {}".format(self.test_db_name))
            self.test_cursor.execute("DROP DATABASE {}".format(self.test_empty_db))
    ...
    def test_bad_credentials(self):
        ...
        self.assertIsNone(response)
        response = connector.get_connection(user="NonexistantUser", passwd="BadPassword")
